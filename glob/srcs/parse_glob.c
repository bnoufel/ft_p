...
static int			check_access_glob_file(t_parse_glob *glob,  char
*d_name)
{
	char			*str;
								...
								t_data_glob **data)
{
	...
	{
		ft_asprintf(&str, "%s%s%s", glob.before,
...
int					start_glob(char *pattern, t_data_glob
**data)
{
	t_parse_glob	glob;
	DIR				*odir;
