...
all: glob ft_printf $(CLIENT) $(SERVER)
...
$(CLIENT): $(GLOBDIR)/$(LIBGLOB) $(PRINTFDIR)/$(LIB) $(OBJSDIR) $(OBJSTOOLS) $(OBJSCLIENT)
...
$(SERVER): $(GLOBDIR)/$(LIBGLOB) $(PRINTFDIR)/$(LIB) $(OBJSDIR) $(OBJSTOOLS) $(OBJSSERVER)
